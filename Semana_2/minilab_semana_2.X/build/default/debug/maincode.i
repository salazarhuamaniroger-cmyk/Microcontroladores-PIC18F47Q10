...
# 9 "maincode.s" 2
    ...
    configuro:
        ...
        ; ((PORTA) and 0FFh), 0, a como entrada
        bsf TRISA,0,1 ; ((PORTA) and 0FFh), 0, a entrada
        bcf ANSELA,0,1 ; ((PORTA) and 0FFh), 0, a entrada digital

        ; ((PORTA) and 0FFh), 1, a como entrada
        bsf TRISA,1,1 ; ((PORTA) and 0FFh), 1, a entrada
        bcf ANSELA,1,1 ; ((PORTA) and 0FFh), 1, a entrada digital

        ; ((PORTA) and 0FFh), 2, a como entrada
        bsf TRISA,2,1 ; ((PORTA) and 0FFh), 2, a entrada
        bcf ANSELA,2,1 ; ((PORTA) and 0FFh), 2, a entrada digital


        ; ((PORTC) and 0FFh), 0, a como salida
        bcf TRISC,0,1 ; ((PORTC) and 0FFh), 0, a salida
        bcf ANSELC,0,1 ; ((PORTC) and 0FFh), 0, a salida digital

        ; ((PORTC) and 0FFh), 1, a como salida
        bcf TRISC,1,1 ; ((PORTC) and 0FFh), 1, a salida
        bcf ANSELC,1,1 ; ((PORTC) and 0FFh), 1, a salida digital

        ; ((PORTC) and 0FFh), 2, a como salida
        bcf TRISC,2,1 ; ((PORTC) and 0FFh), 2, a salida
        bcf ANSELC,2,1 ; ((PORTC) and 0FFh), 2, a salida digital
    ...
    inicio:
        ...
        ;--------------------------------
        ; Comprobacion de ((PORTA) and 0FFh), 0, a
        ;--------------------------------

        btfss PORTA,0,1 ; Comprueba ((PORTA) and 0FFh), 0, a y salta si esta en 1
        bra es_falso_1 ; Si ((PORTA) and 0FFh), 0, a esta en 0, salta a es_falso_1

        bcf LATC,0,1 ; Si ((PORTA) and 0FFh), 0, a esta en 1, pone ((PORTC) and 0FFh), 0, a en 0
        bra revisar_RA1 ; Continua con la comprobacion de ((PORTA) and 0FFh), 1, a


    es_falso_1:

        bsf LATC,0,1 ; Si ((PORTA) and 0FFh), 0, a esta en 0, pone ((PORTC) and 0FFh), 0, a en 1
        bra revisar_RA1 ; Continua con la comprobacion de ((PORTA) and 0FFh), 1, a
    ...
    revisar_RA1:
        ...
        ;--------------------------------
        ; Comprobacion de ((PORTA) and 0FFh), 1, a
        ;--------------------------------

        btfss PORTA,1,1 ; Comprueba ((PORTA) and 0FFh), 1, a y salta si esta en 1
        bra es_falso_2 ; Si ((PORTA) and 0FFh), 1, a esta en 0, salta a es_falso_2

        bcf LATC,1,1 ; Si ((PORTA) and 0FFh), 1, a esta en 1, pone ((PORTC) and 0FFh), 1, a en 0
        bra revisar_RA2 ; Continua con la comprobacion de ((PORTA) and 0FFh), 2, a


    es_falso_2:

        bsf LATC,1,1 ; Si ((PORTA) and 0FFh), 1, a esta en 0, pone ((PORTC) and 0FFh), 1, a en 1
        bra revisar_RA2 ; Continua con la comprobacion de ((PORTA) and 0FFh), 2, a
    ...
    revisar_RA2:
        ...
        ;--------------------------------
        ; Comprobacion de ((PORTA) and 0FFh), 2, a
        ;--------------------------------

        btfss PORTA,2,1 ; Comprueba ((PORTA) and 0FFh), 2, a y salta si esta en 1
        bra es_falso_3 ; Si ((PORTA) and 0FFh), 2, a esta en 0, salta a es_falso_3

        bcf LATC,2,1 ; Si ((PORTA) and 0FFh), 2, a esta en 1, pone ((PORTC) and 0FFh), 2, a en 0
        bra inicio ; Regresa al inicio


    es_falso_3:

        bsf LATC,2,1 ; Si ((PORTA) and 0FFh), 2, a esta en 0, pone ((PORTC) and 0FFh), 2, a en 1
        bra inicio ; Regresa al inicio
