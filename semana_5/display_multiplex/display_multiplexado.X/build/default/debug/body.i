...
configuro:
    ...
    bcf ANSELC, 0, 1 ; ((PORTC) and 0FFh), 0, a digital
    bcf TRISC, 1, 1 ; ((PORTC) and 0FFh), 1, a salida
    bcf ANSELC, 1, 1 ; ((PORTC) and 0FFh), 1, a digital
    bcf TRISC, 2, 1 ; ((PORTC) and 0FFh), 2, a salida
    bcf ANSELC, 2, 1 ; ((PORTC) and 0FFh), 2, a digital
    bcf TRISC, 3, 1 ; ((PORTC) and 0FFh), 3, a salida
    bcf ANSELC, 3, 1 ; ((PORTC) and 0FFh), 3, a digital
    bcf TRISC, 4, 1 ; ((PORTC) and 0FFh), 4, a salida
    bcf ANSELC, 4, 1 ; ((PORTC) and 0FFh), 4, a digital
    bcf TRISC, 5, 1 ; ((PORTC) and 0FFh), 5, a salida
    bcf ANSELC, 5, 1 ; ((PORTC) and 0FFh), 5, a digital
    bcf TRISC, 6, 1 ; ((PORTC) and 0FFh), 6, a salida
    bcf ANSELC, 6, 1 ; ((PORTC) and 0FFh), 6, a digital
    ;=====================
    ...
    bcf ANSELA, 0, 1 ; ((PORTA) and 0FFh), 0, a digital
    bsf WPUA, 0, 1 ; pull-up activado en ((PORTA) and 0FFh), 0, a

    ; boton 3
    bsf TRISB, 0, 1 ; ((PORTB) and 0FFh), 0, a entrada
    bcf ANSELB, 0, 1 ; ((PORTB) and 0FFh), 0, a digital
    bsf WPUB, 0, 1 ; pull-up activado en ((PORTB) and 0FFh), 0, a
    ...
    bcf TRISD, 1, 1 ; ((PORTD) and 0FFh), 1, a salida
    bcf ANSELD, 1, 1 ; ((PORTD) and 0FFh), 1, a digital
    ; transistor 3 (Dígito 3)
    bcf TRISD, 2, 1 ; ((PORTD) and 0FFh), 2, a salida
    bcf ANSELD, 2, 1 ; ((PORTD) and 0FFh), 2, a digital
...
peru:
    ...
    TBLRD*+ ; Lee 0x150
    movff TABLAT, LATC
    bsf LATD, 0, 1 ; Enciende ((PORTD) and 0FFh), 0, a
    call nopes
    bcf LATD, 0, 1 ; Apaga ((PORTD) and 0FFh), 0, a

    ; --- Letra 'e' ---
    TBLRD*+ ; Lee 0x151
    movff TABLAT, LATC
    bsf LATD, 1, 1 ; Enciende ((PORTD) and 0FFh), 1, a
    call nopes
    bcf LATD, 1, 1 ; Apaga ((PORTD) and 0FFh), 1, a

    ; --- Letra 'r' ---
    TBLRD*+ ; Lee 0x152
    movff TABLAT, LATC
    bsf LATD, 2, 1 ; Enciende ((PORTD) and 0FFh), 2, a
    call nopes
    bcf LATD, 2, 1 ; Apaga ((PORTD) and 0FFh), 2, a

    ; --- Letra 'U' ---
    TBLRD*+ ; Lee 0x153
    movff TABLAT, LATC
    bsf LATD, 3, 1 ; Enciende ((PORTD) and 0FFh), 3, a
    call nopes
    bcf LATD, 3, 1 ; Apaga ((PORTD) and 0FFh), 3, a
